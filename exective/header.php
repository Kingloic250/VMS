	 ...
	 <div id="sidebar">
		...
		<ul class="list-unstyled component m-0">
		  ...
		  <ul class="collapse list-unstyled menu" id="homeSubmenu2">
		     <li><a href="leader1.php">Mudugudu</a></li>
			 <li><a href="leader2.php">Mutwarasibo</a></li>
		  </ul>
		  </li>
		  ...
		  class="dropdown-toggle">
		  <i class="fas fa-house"></i>In Cell / Mukagari
		  </a>
		  <ul class="collapse list-unstyled menu" id="homeSubmenu4">
		     <li><a href="village.php">Umudugudu</a></li>
			 <li><a href="isibo.php">Isibo</a></li>
		  </ul>
		  </li>
		  ...
		  <ul class="collapse list-unstyled menu" id="homeSubmenu3">
		     <li><a href="#">Monthly / Ukwezi</a></li>
			 <li><a href="#">Annual / Umwaka</a></li>
		  </ul>
		  </li> -->
		  ...
		  <div class="top-navbar">
		     <div class="xd-topbar">
					     ...
					     <div class="xp-searchbar">
						     <form action="searching.php" method="POST">
							    <div class="input-group">
								  <input type="search" autocomplete="off" class="search-results" name="search" id="live"
				 ...
				 <div class="xp-breadcrumbbar text-center">
				    <h4 class="page-title">Exective Dashboard</h4>
					<ol class="breadcrumb">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Signing Out Exective</h5>
      ...
      <div class="modal-footer">
        ...
        <a href="logout.php?user_id=<?php echo md5($_SESSION['user_id']); ?>"><button type="button" class="btn btn-danger">Sign Out</button></a>
      </div>
    </div>
  </div>
</div>
...
$ret = mysqli_query($connect,"SELECT *FROM cell_table WHERE cell_id = '$cell_id'");
$get = mysqli_fetch_assoc($ret);
$select = mysqli_query($connect,"SELECT *FROM exective WHERE e_id = '$user_id'");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p class="title">Title: Executive, of <?php echo $get['cell'] ?> cell</p> 
		<p>Email: <?php echo strtolower($fetch['email']) ?></p>
		<p>Phone Number: <?php echo '+'.strtolower($fetch['contact']) ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
      </div>

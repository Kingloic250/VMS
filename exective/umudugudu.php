...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    elseif (!is_numeric($v_id)) {
        ...
        $_SESSION['v_id'] = $v_id;
        if ($cell == $cell_id) {
            echo "<script>location.href='citizen_vill.php';</script>";
        }
        else {
...
?>
<title>VMS - Choose Village</title>
<!------main-content-start-----------> 
                                    ...
                                    <div class="table-title">
                                        <div class="row">
                                            <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
                                                <h2 class="ml-lg-2">Choose the village (umudugudu)</h2>
                                            </div>
			...
			<select name="cell" class="form-control" id="selectId">
		...
		<div class="form-group">
            ...
            <select name="v_id" class="form-control" id="show">

...
$records = mysqli_query($connect,"SELECT * FROM citizen WHERE i_id = '$i_id'");
...
$retreive = mysqli_query($connect,"SELECT *FROM citizen WHERE i_id = '$i_id' LIMIT $start,$rows_per_page");
...
$check = mysqli_query($connect,"SELECT *FROM citizen WHERE i_id = '$i_id'");
?>
			     ...
			     <div class="row">
				    <div class="col-md-12">
					   ...
					   <div class="table-title">
					     <div class="row">
						     <a href="sub_village.php"><i class="fas fa-arrow-left" style="margin-top:10px;color:#eee;background:rgb(60, 60, 60);"></i></a>
						     <div class="col-sm-7 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-3">Manage Citizens(Abaturage) in Sub village (<?php echo mysqli_num_rows($check) ?>)</h2>
							 </div>
					     </div>
					   </div>
					   <?php

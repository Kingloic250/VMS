...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    elseif (empty($password)){
        ...
        $select = mysqli_query($connect,"SELECT *FROM mudugudu WHERE phones = '$phone'");
        if ($select -> num_rows == 1){
            $fetch = $select -> fetch_assoc();
            if ($fetch['password'] == $password){
                $_SESSION['v_id'] = $fetch['v_id'];
                $_SESSION['m_id'] = $fetch['m_id'];
...
<div class="img">
    <img src="../img/vms.png" alt="" style="width: 100px;height: 100px;margin-left: 20px;margin-top: 24px;">
                ...
                <div class="container-fluid">
                    <form method="post" autocomplete="off">
                        <div class="row align-items-center justify-content-center">
                            <div class="rounded p-4 p-sm-5 my-4 mx-3 col-sm-3 col-md-7" style="backdrop-filter: blur(15px);box-shadow:0 1px 7px 1px rgba(0,0,0,0.2);">
                            <?php if (isset($errors)): ?>
            ...
            <?php endif ?>
                                <h3 style="font-family: 'poppins',sans-serif;" class="text-light">SIGN IN VMS AS LEADER 1 (MUDUGUDU)</h3>
                                <div class="form-floating mb-3 mt-3" style="margin-top:40px;">
                                    <input type="text" style="color:white;font-family: 'poppins',sans-serif;border-radius:20px;background: transparent;" name="phone" class="form-control" placeholder="example@example.com">

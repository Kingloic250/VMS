			     ...
			     <div class="row">
				    <div class="col-md-12">
					   ...
					   <div class="table-title">
					     <div class="row">
						     <a href="register.php"><i class="fas fa-arrow-left" style="margin-top:10px;color:#eee;background:rgb(60, 60, 60);"></i></a>
						     <div class="col-sm-7 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-3">Search result for <?php echo $search ?> (<?php echo mysqli_num_rows($select1) ?>)</h2>
							 </div>
					     </div>
					   </div>

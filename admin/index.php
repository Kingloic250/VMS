...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (empty($password)) {
        ...
        $select = mysqli_query($connect,"SELECT *FROM user_table WHERE email = '$email'");
...
<html>
<head>
    <title>Sign In VMS Administration</title>
</head>
<meta charset="UTF-8">
...
<div class="img">
    <img src="../img/vms.png" alt="" style="width: 100px;height: 100px;margin-left: 20px;margin-top: 20px;">
</div>
            ...
            <?php endif ?>
                                <h2 style="font-family: 'poppins',sans-serif;color:white;" class="text-light">SIGN IN VMS AS ADMIN</h2>
                                <div class="form-floating mb-3 mt-3" style="margin-top:40px;">
                                    ...
                                    <label for="uname" style="font-family: 'poppins',sans-serif;color:white;">Email</label>
                                ...
                                <div class="form-floating mb-3 mt-3">
                                    ...
                                    <label for="pwrd" style="font-family: 'poppins',sans-serif;color:white;">Password</label>
                                </div>

...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    elseif (!is_numeric($year)) {
        ...
        $select = mysqli_query($connect,"SELECT *FROM umuganda JOIN village ON (umuganda.v_id=village.v_id)
                 JOIN cell_table ON (cell_table.cell_id=village.cell_id) JOIN sector ON (cell_table.s_id=sector.s_id)
                  JOIN district ON (district.d_id=sector.d_id) JOIN user_table ON (district.d_id=user_table.d_id)
                   WHERE u_month = '$month' AND u_year = '$year' AND user_id = '$user_id'");
			     ...
			     <div class="row">
				    <div class="col-md-12">
					   ...
					   <div class="table-title">
					     <div class="row">
                         <a href="umuganda.php"><i class="fas fa-arrow-left" style="margin-top:10px;color:#eee;background:rgb(60, 60, 60);"></i></a>
            ...
            <table class="table table-hover">
						  ...
						  <tbody>
							...
							?>
							 ...
							 <th><?php echo $get['u_month']."-".$get['u_year'] ?></th>
...
<?php
                                if (isset($errormsg)) {
                                    ...
                                    <a href="umuganda.php"><button class="btn btn-secondary" style="margin-left:450px;">Back</button></a>
                                    <?php
                                }
                                ?>
</div>
